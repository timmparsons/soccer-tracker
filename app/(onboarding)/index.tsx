    ...
    <View style={s.screen}>
      <ScrollView contentContainerStyle={s.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={s.paywallPricing}>
          {/* TODO: Wire up RevenueCat when monetization branch merges */}
          <View style={s.pricingOption}>
        ...
        <View style={{ height: 16 }} />
        {/* TODO: Replace with RevenueCat purchase call */}
        <TouchableOpacity style={s.paywallCta} onPress={onNext} activeOpacity={0.85}>
