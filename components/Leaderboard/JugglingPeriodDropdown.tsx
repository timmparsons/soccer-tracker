...
export type JugglingPeriod = 'week' | 'alltime';

interface Props {
  active: JugglingPeriod;
  onChange: (period: JugglingPeriod) => void;
}

const LABELS: Record<JugglingPeriod, string> = {
  week: 'This Week',
  alltime: 'All Time',
};

const OPTIONS: JugglingPeriod[] = ['week', 'alltime'];

const SCREEN_WIDTH = Dimensions.get('window').width;

const JugglingPeriodDropdown = ({ active, onChange }: Props) => {
...
export default JugglingPeriodDropdown;
